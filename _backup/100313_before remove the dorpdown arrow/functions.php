...
function add_menu_item ( $items, $args ) {
	...
	if( 'primary' === $args -> theme_location ) {
 		...
 		$items .= '<li class="menu-item settingParent"><span class="glyphicon glyphicon-cog"></span><li class="menu-item logout"><a href="'.wp_logout_url().'" style="display:none;"></a></li></li>';
