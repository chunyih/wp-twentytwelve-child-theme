jQuery(document).ready(function($) {
	...
	$("ul.nav-menu > li.menu-item.logout").insertAfter($("ul.nav-menu > li.settingParent > ul.settingsMenu > li").last()).css("display", "block"); // move logout under settings
	...
	$(document).click( function() {
    	if ($("ul.nav-menu > li.menu-item > a[href='#dept']").css("display") != "none") { fold("dept") }; // if dept is on
