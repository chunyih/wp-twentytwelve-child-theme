...
?>
<script>console.log("### form-topic.php ###")</script>
...
<!-- <div class="large-3"><a href="#" class="button addForumTopic"><span class="glyphicon glyphicon-plus"></span> Add New Topic</a></div> -->
			...
			<fieldset class="bbp-form">
				...
				<div>
					...
					<p>
						...
						<input required type="text" id="bbp_topic_title" value="<?php bbp_form_topic_title(); ?>" tabindex="<?php bbp_tab_index(); ?>" size="40" name="bbp_topic_title" maxlength="<?php bbp_title_max_length(); ?>" />
					</p>
